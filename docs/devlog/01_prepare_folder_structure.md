...
## 🛠️ Devlog: ArahBelajarAI - Persiapan Struktur Folder

Document ini mencatat step by step proses persiapan struktur folder untuk proyek ArahBelajarAI. Tujuannya adalah untuk memastikan bahwa semua file dan direktori diatur dengan baik sehingga memudahkan pengembangan dan pemeliharaan proyek ke depannya.

### Tasks yang dilakukan

- Preparasi struktur folder dasar untuk proyek ArahBelajarAI.
- [x] Membuat folder utama proyek `DB10-Capstone-ArahBelajarAI/`
- [x] Membuat subfolder `docs/` untuk dokumentasi proyek
- [x] Membuat subfolder `frontend/` untuk kode frontend aplikasi dengan nextjs 16
- [x] Membuat subfolder `backend/` untuk kode backend aplikasi dengan fastapi
- [x] Membuat subfolder `ml/` untuk model machine learning dan data terkait
- [/] Membuat file README.md di folder utama untuk deskripsi proyek
- [/] Membuat file .gitignore untuk mengabaikan file yang tidak perlu di-track oleh Git
- [x] Menambahkan file devlog di dalam folder `docs/devlog/` untuk mencatat perkembangan proyek
